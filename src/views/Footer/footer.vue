			...
			<div class="row align-items-top">
				...
				<div class="col-12 col-lg-2 ml-auto text-lg-left mt-4 mt-lg-0">
					...
					<p class="text-h3">
						...
						<!-- 电话 -->
						<el-tooltip class="box-item" effect="dark" content="17780527570" placement="top">
							<a><svg t="1708397010931" class="icon" viewBox="0 0 1024 1024" version="1.1"
									xmlns="http://www.w3.org/2000/svg" p-id="4827" width="16" height="16">
									<path
...
export default defineComponent({
	...
	setup() {
		...
		const open = () => {
			ElMessageBox.alert(
				`<img src="${img}" alt="3069394597"  width="396" height="300"/>`,
				'二维码暂替',
				{
					autofocus: false,
